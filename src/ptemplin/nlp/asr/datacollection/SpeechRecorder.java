...
public class SpeechRecorder {
	...
	private static final String BASE_AUDIO_STORAGE_DIR = "C:/Projects/SpeechRecognition/data/";
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for (int i = 1; i <= COLLECTION_SIZE; i++) {
			...
			if (recorded != null) {
				recorder.writeAudioToFile(recorded, BASE_AUDIO_STORAGE_DIR + wordDir + "/", i);
			}
		}
	}
