...
public class SpeechFileReader {
	...
	private static final String SPEECH_DATA_BASE_DIR = "C:/Projects/SpeechRecognition/data/";
	...
	public SpeechSample readSpeechFileForTrainingData(String dir, int dataNum)
		...
		String fileName = SPEECH_DATA_BASE_DIR + dir + "/" + dataNum + SPEECH_DATA_FILE_EXTENSION;
