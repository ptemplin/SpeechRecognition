...
public class HmmLoadSave {
	
	public static final String DIR = "C:/Projects/SpeechRecognition/tmp/";
	...
	public static void saveHmmTransitionProbs(String modelName, ContinuousHMM model) {
		String fileName = DIR + modelName + "_TP.mat";
	...
	public static void saveHmmOutputParameters(String modelName, ContinuousHMM model) {
		String meanFileName = DIR + modelName + "_MEAN.mat";
		String varFileName = DIR + modelName + "_VAR.mat";
